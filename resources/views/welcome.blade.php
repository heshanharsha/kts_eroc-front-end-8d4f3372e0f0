...
<html lang="{{ app()->getLocale() }}">
    ...
    <body style="font-family: 'Roboto', sans-serif;">
        <div style="width: 780px;height: 748px;margin-left: auto;margin-right: auto;background: #f2f2f2;">
          ...
          <div style="width: 70%;background: #fff;height: 70%;margin: auto;position: relative;top: -64px;border-radius: 5px;box-shadow: 0px 0px 1px 0px;">
            ...
            <p style="padding: 3px 35px;">You are receiving this email because we  received a password reset request for your account.</p>
            <div style="text-align: center;margin-top: 3em;margin-bottom: 3em;">
              <a href="#" style="text-decoration: none;background: #ff4800;;color: #ffffff;padding: 10px 27px;border-radius: 4px;">Reset Password</a>
            </div>
            <p style="padding: 3px 35px;">If you did not request a password reset, no further action is required.</p>
