...
@Component({
  selector: 'app-register-secretary-naturalp',
  templateUrl: './register-secretary-naturalp.component.html',
  styleUrls: ['./register-secretary-naturalp.component.scss'],

})
export class RegisterSecretaryNaturalpComponent implements OnInit {
